...
// Your code here...
const bestFruit = fruit.slice(37, 47);
...
// Your code here ...
function checkOxygen(str) {
  if (str.includes("oxygen")) {
    return "The string include the word 'oxygen'";
  } else {
    return "The string does not include the word 'oxygen'";
  }
}
console.log(checkOxygen(funnyHeadline1));
// Check the second headline
// Your code here ...
console.log(checkOxygen(funnyHeadline2));
/*******************************************
